...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>Edit Society Admin</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
<form id="adduser" name="adduser"  enctype="multipart/form-data" method="POST" action="<?php echo $this->config->item("base_url");?>admin/society_user/edit/" autocomplete="off">
		...
		<td></td>
			...
			<tr>
			<th>Country</th><td><input type="text"   id="country" name="country" class="inp-form" value="<?php echo $data['country']; ?>" /></td>
			<td>
			</td>
		</tr>
