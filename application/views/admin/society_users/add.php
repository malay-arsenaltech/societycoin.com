...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>New Society Admin</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
<form id="adduser" name="adduser"  enctype="multipart/form-data" method="POST" action="<?php echo $this->config->item("base_url");?>admin/society_user/add" autocomplete="off">
		...
		<tr>
			<th>Address</th><td><textarea   id="address" class="inp-form" name="address" value="" > </textarea></td>
			<td>
			</td>
		</tr>
		<tr>
		<th>City</th><td><input type="text"   id="city" name="city" class="inp-form" value="" /></td>
		<td></td>
		</tr>
			<tr>
			 <th>State</th><td><input type="text" id="state"   name="state" class="inp-form" value="" /></td>
			<td>
			</td>
		</tr>
			<tr>
			<th>Country</th><td><input type="text"   id="country" name="country" class="inp-form" value="" /></td>
			<td>
			</td>
		</tr>
