...
<?php } ?>
  ...
  <div style="padding-right:17px; float:right;margin-right:73px;" >
        ...
        <form id="search" name="search" action="<?php  echo base_url(); ?>admin/society_user" method="get" >
	...
	<tr>
		...
		<div id="content-table-inner">
		   ...
		   <div id="table-content">
				...
				<tr>
<th class="table-header-repeat line-left minwidth-1"><span>S.No</span>	</th>
...
<td><?php echo $k; ?></td>
					<td><a href="<?php echo base_url();?>admin/society_user/edit/<?php echo $data['id']; ?>" ><?php echo $data['fname']; ?></a></td>
					...
					<a href="<?php echo base_url();?>admin/society_user/edit/<?php echo $data['id']; ?>" title="Edit" class="icon-1 info-tooltip"></a>
                    ...
                    <?php 
					    ...
					    if($data['status']==1){
						 ...
						 ?>
                 	     ...
                 	     <a href="<?php echo base_url();?>admin/society_user/changedStatus/<?php echo $data['id']; ?>" title="Publish" class="icon-5 info-tooltip"></a>

                         <?php }else if($data['status']==0)

						   {?>

					<a href="<?php echo base_url();?>admin/society_user/pchangedStatus/<?php echo $data['id']; ?>" title="UnPublish" class="icon-2 info-tooltip"></a>
                     <?php }?>
			...
			<?php $k++; } }    	else {
				echo "<tr><td colspan='8'> No society admin found</td></tr>";
