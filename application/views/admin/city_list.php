...
<?php } ?>
  ...
  <div style="padding-right:17px; float:right;margin-right:73px;" >
        ...
        <form id="search" name="search" action="<?php  echo base_url(); ?>admin/master/citylist" method="get" >
...
<a href="<?php echo base_url();?>admin/master/editcity/<?php echo $data['id']; ?>" title="Edit City" class="icon-1 info-tooltip"></a>
          <a onclick="javascript:return confirm('Are you sure to delete?');" href="<?php echo base_url();?>admin/master/delete_city/<?php echo $data['id']; ?>" title="delete record" class="info-tooltip"><img src="<?php echo base_url();?>images/del.png"    ></a>
