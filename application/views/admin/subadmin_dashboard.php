            ...
            <div id="table-content">
                <div class="tabbed-area cur-nav-fix-2"  style="margin-left: 40px;">
                    ...
                    <div class="box-wrap">
                        ...
                        <?php if ($this->session->userdata('utype') == 4) { ?>
                            <div class="box-eight">
                                <a  style=" float: right; margin-bottom:3px;" class="btnb" href="javascript:newPopup('<?php echo base_url(); ?>admin/allresidence/print_all_bill/1/<?php echo $this->input->get_post('search_text'); ?>');"  >Print All</a>
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" id="product-table">
                                    <tbody><tr>
                                            <th class="table-header-repeat line-left" style="width:20px;"><span>S.No</span>	</th>
