...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="<?php echo AdminThemeUrl; ?>images/shared/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<!--  start login-inner -->
	<div id="login-inner">
    <form id="loginform" name="loginform" action="<?php echo base_url(); ?>login/user" method="post">
