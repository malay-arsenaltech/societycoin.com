		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<th class="table-header-repeat line-left" style="width:20px;"><span>S.No</span>	</th>
					...
					<th class="table-header-repeat line-left minwidth-1"><span>Title</span>	</th>

					<th class="table-header-repeat line-left minwidth-1"><span>Meta Tag</span></th>

					<th class="table-header-repeat line-left"><span>Description</span></th>
...
//						print_r($data); exit();
				...
				<tr>
					...
					<a href="<?php echo base_url();?>admin/allcmspages/editcmspage/<?php echo $data['id']; ?>" title="Edit" class="icon-1 info-tooltip"></a>
                    ...
                    <?php 
					    ...
					    if($data['status']==1){
						 ...
						 ?>
                 	     ...
                 	     <a href="<?php echo base_url();?>admin/allcmspages/changedStatus/<?php echo $data['id']; ?>" title="Publish" class="icon-5 info-tooltip"></a>

                         <?php }else if($data['status']==0)

						   {?>

					<a href="<?php echo base_url();?>admin/allcmspages/pchangedStatus/<?php echo $data['id']; ?>" title="UnPublish" class="icon-2 info-tooltip"></a>

                     <?php }?>
 <a href="<?php echo base_url();?>admin/allcmspages/delete/<?php echo $data['id']; ?>" title="Delete" onclick="return confirm('Are you sure to delete?');"  class=" info-tooltip"><img src="<?php echo base_url();?>images/del.png"  style="margin-left:10px;"  ></a>
					</td></tr>
