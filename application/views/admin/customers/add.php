...
<!-- start content -->
<div id="content">
<div id="page-heading"><h1>New Customer</h1></div>
...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
<form id="adduser" name="adduser"  enctype="multipart/form-data" method="POST" action="<?php echo $this->config->item("base_url");?>admin/customers/add" autocomplete="off">
