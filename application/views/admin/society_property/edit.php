   ...
   <div id="message-green">
	...
	<tr>
		...
		<!--  start content-table-inner ...................................................................... START -->
		  <form  id="addnewsocity" name="addnewsocity" method="post"  action="<?php echo base_url();?>admin/society_property/edit" >
                ...
                <tr>
				 ...
				 $sel = ( $property['societyid'] == $s['id']) ?  " selected='selected' " : "";
				 
				 
				  echo "<option $sel value=".$s['id'].">".$s['society_title']."</option>";
