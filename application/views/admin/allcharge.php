		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-check"><a href="#" ></a> </th>

					<th class="table-header-repeat line-left minwidth-1"><a href="#">Property Address</a>	</th>

					<th class="table-header-repeat line-left"><a href="3">Bill Name</a></th>
...
//						echo $this->session->userdata('userid');
	...
	//					echo '<pre>';print_r($data); echo '</pre>';
					...
					<td><input style="display:none;" id="checkid<?php echo $data['id']; ?>" name="checkid[]" value="<?php echo $data['id']; ?>"  type="checkbox"/></td>
                    ...
                    <?php 
					    ...
					    if($data['status']==1){
						 ...
						 ?>
                 	     ...
                 	     <a href="<?php echo base_url();?>admin/allsociety/billchangedStatus?pid=<?php echo $data['id']; ?>" title="Publish" class="icon-5 info-tooltip"></a>

                         <?php }else if($data['status']==0)

						   {?>

					<a href="<?php echo base_url();?>admin/allsociety/billpchangedStatus?pid=<?php echo $data['id']; ?>" title="UnPublish" class="icon-2 info-tooltip"></a>
                    ...
                    <?php 
					    ...
					    if($data['status']==1){
						 ...
						 ?>
                 	     ...
                 	     <a href="<?php echo base_url();?>admin/allpropertys/changedStatus?pid=<?php echo $data['id']; ?>" title="Publish" class="icon-5 info-tooltip"></a>

                         <?php }else if($data['status']==0)

						   {?>

					<a href="<?php echo base_url();?>admin/allpropertys/pchangedStatus?pid=<?php echo $data['id']; ?>" title="UnPublish" class="icon-2 info-tooltip"></a>
