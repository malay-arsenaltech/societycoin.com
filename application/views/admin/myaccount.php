...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
	<?php  if($this->session->userdata('utype') == 4)  echo "<h1>Account For Society</h1>";  else  echo "<h1>My Account</h1>";  ?>
...
<?php } ?>
	...
	<tr>
		...
		<!--  start content-table-inner ...................................................................... START -->
		  <form method="post" id="addnewsocity" name="addnewsocity"    action="<?php echo base_url();?>admin/myaccount/update" >
				...
				<thead>
					...
					<?php for ($i = 1; $i <= 31; $i++) { 
            $selc = (isset($billing_cycle_date) && $i == $billing_cycle_date) ? " selected='selected' "  : "";
		...
		?>
				 ...
				 <?php } ?>
                    ...
                    <th>E-mail</th><td><input   type="text" class="inp-form" id="email" name="email" value="<?php echo $data['email']; ?>" ></td>
				     ...
				     <tr>    
                    <th>Login id</th><td><input   type="text" class="inp-form" disabled id="login_id" name="login_id" value="<?php echo $data['username']; ?>" ></td>
					 </tr>
...
<th>City</th><td><input type="text" maxlength="25"  id="city" name="city" class="inp-form" value="<?php echo $data['city']; ?>" ></td>
		           ...
		           <tr>    
					...
					<tr>                   
					   ...
					   <th>Old Password</th><td><input   type="password" type="text" class="inp-form" id="password" name="password" value="" ></td></tr>			
					   ...
					   <th>Confirm New Password</th><td><input  maxlength="15"  type="password" class="inp-form" id="cpassword" name="cpassword" value="" ></td>
						...
						<tr>
                        <th>   </th>
                         <td><input type="submit" class="form-submit"  value="Update" ></td>
