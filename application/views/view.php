...
#send label {
    ...
    <div id="vertical_container" >
                <form id="send" name="send" action="<?php echo base_url();?>message" method="post" style="margin:10px; background:#fff; border:1px solid #363;" >
                    <h4 style="margin:10px;"><a  href="#" >Send Message</a></h4>
                <table style="margin:10px;">
                <tr><td><label>Send To Society <br/> Admin </label></td><td><input type="text" value="<?php echo $data[0]->fname.'&nbsp;'.$data[0]->lname; ?>"  /></td></tr>
