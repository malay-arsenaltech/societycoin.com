            ...
            <table id="id-form" class="table table-bordered">
              <thead>
                ...
                <tr>
                 ...
                 <input type="hidden" id="societyid" name="societyid" value="<?php echo $_REQUEST['said']; ?>" />
                 <input type="hidden" id="chargeid" name="chargeid" value="<?php echo $_REQUEST['chargeid']?>" />
