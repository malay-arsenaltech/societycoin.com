...
<div id="content">
	...
	<tr>
		...
		<!--  start content-table-inner ...................................................................... START -->
		  ...
		  <form  id="addnewsocity" name="addnewsocity" method="post" onsubmit="return validateform()" action="<?php echo base_url();?>admin/allsociety/update" >
				...
				<thead>
                  ...
                  <?php foreach($allcountry as $allcountry) { ?>
                           ...
                           <option <?php if($data['countryid']==$allcountry['id']){ echo 'selected="selected"';} ?>s  value="<?php echo $allcountry['id']?>" ><?php echo $allcountry['countryname']?></option>
       ...
       {?>
                ...
                <tr>    
                 ...
                 <th rowspan="4" ><label>Chare head</label><br/>

                    <?php $charge=explode(',',$data['chargehead_id']); ?>
                    ...
                    <select style="height:180px;" multiple="multiple" id="chargehead" name="chargehead[]">
                     ...
                     <?php foreach($bills as $bill)

					   {
						   ...
						   <option <?php if(in_array($bill['id'],$charge, TRUE)){ echo 'selected="selected"';} ?>  value="<?php echo $bill['id'] ?>"><?php echo $bill['bill_name']; ?></option>
                    ...
                    <tr>    
				    	...
				    	<th ><label>Society Name</label></th><th><input class="inp-form" type="text" id="society_title" name="society_title" value="<?php echo $data['society_title']; ?>" /></th>
                    ...
                    <tr><th colspan="2"><label>Contact Person Details</label></th></tr>
                     ...
                     <tr>    
				    	...
				    	<th ><label>Name</label></th><th><input class="inp-form" type="text" id="so_name" name="so_name" value="<?php echo $data['so_name']; ?>" /></th>
                     ...
                     <tr>    
				    	...
				    	<th ><label>Email</label></th><th><input class="inp-form" type="text" id="so_email" name="so_email" value="<?php echo $data['so_email']; ?>" /></th>
                     ...
                     <tr>    
				    	...
				    	<th ><label>Password</label></th><th><input class="inp-form" type="password" id="so_password" name="so_password" value="" /></th>
                     ...
                     <tr>    
				    	...
				    	<th ><label>Mobile Number</label></th><th><input class="inp-form" type="text" id="so_mobile" name="so_mobile" value="<?php echo $data['so_mobile']; ?>" /></th>
