		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Meta Tag</a></th>
...
//						print_r($data); exit();
				...
				<tr>
					...
					<a href="<?php echo base_url();?>admin/allcmspages/editcmspage?sid=<?php echo $data['id']; ?>" title="Edit" class="icon-1 info-tooltip"></a>
                    <?php 
					    if($data['status']==1){
						 ?>
                 	     <a href="<?php echo base_url();?>admin/allcmspages/changedStatus?sid=<?php echo $data['id']; ?>" title="Published" class="icon-5 info-tooltip"></a>
                         <?php }else if($data['status']==0)
						   {?>
					<a href="<?php echo base_url();?>admin/allcmspages/pchangedStatus?sid=<?php echo $data['id']; ?>" title="Unpblished" class="icon-2 info-tooltip"></a>
                     <?php }?>
					</td
				></tr>
			<?php } ?>
