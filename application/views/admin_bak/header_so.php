...
<div class="nav-outer"> 
        ...
        <h2 style="position: absolute; color: rgb(255, 255, 255) ! important; font-size: 16px; right: 89px; top: 125px;">Welcome&nbsp;&nbsp;
        <a href="#" style="color:#fff;" ><?php echo $this->session->userdata('so_name'); ?></a></h2>
		...
		<div id="nav-right">
			...
			<div class="account-drop-inner">
				...
				<a href="<?php echo base_url();?>admin/societyadmin/" id="acc-settings">Home</a>
