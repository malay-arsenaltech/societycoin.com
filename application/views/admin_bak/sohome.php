...
<div id="content">
	...
	<div id="content-table-inner">
            ...
            <?php  if($this->session->userdata('so_id')!=NULL)
                ...
                <div class="tabbed-area cur-nav-fix-2"  style="margin-left: 40px;">
                    ...
                    <ul class="tabs group">
                        ...
                        <li><a id="tab1" href="javascript:void(0)" >Latest User Activity</a></li>
                         <li><a id="tab2" href="javascript:void(0)" >All Properties</a></li>
...
<p class="pagination">    <?php 
                 ...
                 <a href="<?php echo base_url();?>admin/societyadmin?start=<?php echo $Prev ?>&act=act">Prev</a>
...
<?php
                    ...
                    <a href="<?php echo base_url();?>admin/societyadmin?start=<?php echo $start; ?>&act=act">Next</a></p>
				...
				<tbody><tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Properties Address</a>	</th>
              ...
              <?php $i=0;  foreach($property as $data)
...
<?php
              ...
              <?php $i=0;  foreach($pay as $data)
				...
				<tr class="<?php echo $style; ?>">
					...
					<td><a href="<?php echo base_url();?>admin/allusers/transactionview_so?tranid=<?php echo $data['id']; ?>" ><?php echo $data['societyname']; ?></a></td>
                ...
                <p class="pagination">    <?php 
                 ...
                 <a href="<?php echo base_url();?>admin/societyadmin?start=<?php echo $Prev ?>&act=tact">Prev</a>
...
<?php
                    ...
                    <a href="<?php echo base_url();?>admin/societyadmin?start=<?php echo $start; ?>&act=tact">Next</a></p>
