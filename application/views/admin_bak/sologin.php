...
<body id="login-bg"> 
<?php if($this->session->userdata('so_id')=='')
   {?>
<div id="login-holder">
	<!-- start logo -->
    ...
    <form id="loginform" name="loginform" action="<?php echo base_url(); ?>admin/societyadmin/souser" method="post" >
...
<?php } else
     {
		 ...
		 echo '<h1>Hello Society Admin</h1>'; 
