...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {
		...
		$return =  '<script type="text/javascript" src="'.AdminThemeUrl. $data['path'] . '/ckeditor.js"></script>';
		$return .=	"<script type=\"text/javascript\">CKEDITOR_BASEPATH = '" .AdminThemeUrl. $data['path'] . "/';</script>";
	} 
