...
class customers_model extends CI_Model {
    ...
    public function all_customers($start, $limit) {
        ...
        $this->db->select('SQL_CALC_FOUND_ROWS ci_users.*,s.society_title as societyname', false, false);
        ...
        $this->db->join('ci_transaction tr', 'tr.userid=ci_users.id', "left");
        $this->db->join('ci_userpropertys up', 'up.userid = ci_users.id', "left");
        $this->db->join('ci_society s', 's.id = up.societyid', "left");
